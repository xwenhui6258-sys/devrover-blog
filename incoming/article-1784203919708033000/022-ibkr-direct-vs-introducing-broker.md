...
series: "海外资产入门"
status: "draft"
cover: "images/ibkr-direct-vs-introducing-framework.png"
tags:
  - IBKR
  - 盈透证券
  - 介绍经纪商
...
![IBKR 直营、介绍经纪商与第三方软件三层框架](images/ibkr-direct-vs-introducing-framework.png)
...
![同一个“绑定”按钮背后的三条不同路径](images/ibkr-linking-three-cases.png)
...
![IBKR 账户绑定前的决策与核验清单](images/ibkr-binding-decision-checklist.png)

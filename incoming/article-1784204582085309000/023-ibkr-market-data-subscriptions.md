...
description: "从免费非合并实时数据、延迟行情、快照、L1 与 L2 入手，讲清 IBKR 交易权限、行情权限、专业身份和市场数据订阅的选择方法。"
date: 2026-07-16
category: "跨境投资"
series: "海外资产入门"
status: "draft"
cover: "images/ibkr-market-data-map.png"
tags:
  - IBKR
  - 盈透证券
  - 市场数据
...
![IBKR 行情权限和市场数据选择框架](images/ibkr-market-data-map.png)
...
![IBKR 延迟行情六步排查流程](images/quote-delay-diagnosis.png)
...
![IBKR 市场数据方案选择矩阵](images/market-data-choice-matrix.png)

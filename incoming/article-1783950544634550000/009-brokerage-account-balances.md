...
description: "券商 App 里同时出现现金、已结算现金、净清算价值、购买力、可用资金和超额流动性。本文用一套顺序解释这些数字各自回答什么问题。"
date: 2026-07-13
category: "跨境投资"
series: "海外资产入门"
status: "published"
cover: "images/account-money-map.png"
tags:
  - 海外券商
  - IBKR
  - 账户余额
...
> 本文是券商账户字段说明，不是投资、融资、税务或法律建议。不同账户实体、账户类型、产品和市场的计算方法会不同，券商也可能随时提高自家保证金要求。界面入口以你当前使用的 Client Portal、App 或桌面端为准。资料核对日期：2026-07-13。

![现金、净资产、购买力和保证金的关系](images/account-money-map.png)
...
![一笔钱变成可下单额度的路径](images/buying-power-bridge.png)
...
![保证金账户应关注的风险信号](images/margin-warning-signals.png)

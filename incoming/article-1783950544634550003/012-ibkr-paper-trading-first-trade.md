...
series: "海外资产入门"
status: "published"
cover: "images/paper-trading-route.png"
tags:
  - IBKR
  - 模拟交易
  - Paper Trading
...
![IBKR 模拟账户第一次买卖路径](images/paper-trading-route.png)
...
![第一次模拟练习的六个任务](images/simulation-experiment.png)
...
![模拟账户与真实账户的关键差别](images/paper-vs-live.png)

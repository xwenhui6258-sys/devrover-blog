...
description: "从全转、部分转和资产可转性开始，讲清 ACATS 的发起路径、在途限制、成本基础补录和转仓后对账。"
date: 2026-07-13
category: "跨境投资"
series: "海外资产入门"
status: "draft"
cover: "images/acats-timeline.png"
tags:
  - ACATS
  - 转仓
  - IBKR
...
![ACATS 转仓参与方和流程](images/acats-timeline.png)
...
![转仓前的资产可转性体检](images/transferable-assets.png)
...
![转仓前、中、后的核对清单](images/acats-checklist.png)

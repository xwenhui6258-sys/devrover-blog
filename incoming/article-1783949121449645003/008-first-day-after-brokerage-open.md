...
description: "账户通过审核后，第一天先别急着下单。先把官方 App、双重验证、基础货币、交易权限、W-8BEN、入金测试和报表保存设置好。"
date: 2026-07-13
category: "跨境投资"
series: "海外资产入门"
status: "draft"
cover: "images/first-day-checklist.png"
tags:
  - 海外券商
  - 账户安全
  - 2FA
...
> 本文是开户后设置清单，不是税务、法律、换汇、跨境汇款或投资建议。不同券商、居住地和账户实体的设置入口会变化，操作前以当前 App、网页端和官方说明为准。资料核对日期：2026-07-13。

![开户后第一天设置清单](images/first-day-checklist.png)
...
![券商账户安全分层](images/security-layers.png)
...
![权限、税表和入金的先后顺序](images/permissions-tax-flow.png)

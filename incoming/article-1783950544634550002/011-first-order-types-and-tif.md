...
description: "从成交速度、价格保护和不成交风险出发，讲清市价单、限价单、止损单、止损限价单，以及 DAY、GTC 与盘前盘后设置。"
date: 2026-07-13
category: "跨境投资"
series: "海外资产入门"
status: "published"
cover: "images/order-type-map.png"
tags:
  - 海外券商
  - IBKR
  - 市价单
...
> 本文是股票和 ETF 的基础订单教育，不构成证券推荐、交易或止损建议。订单类型、触发方法、可用交易时段和有效期会因券商、市场、产品和路由而不同。界面入口以当前 Client Portal、App 或桌面端为准，提交前以订单预览和合约规则为准。资料核对日期：2026-07-13。

![三种基础订单的选择逻辑](images/order-type-map.png)
...
![限价单与止损单从触发到成交的路径](images/limit-stop-example.png)
...
![订单有效期地图](images/time-in-force-map.png)

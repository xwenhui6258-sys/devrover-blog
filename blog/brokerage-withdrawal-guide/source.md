...
summary: "从可出金现金、交收和入金 hold 开始，完整走一遍 IBKR 出金指令、同名银行账户、费用时效和到账追踪。"
date: 2026-07-13
updated: 2026-07-15
slug: "brokerage-withdrawal-guide"
category: "券商入金"
series: "海外银行卡与资金流转"
status: "published"
...
![从券商到银行的出金流程](assets/withdrawal-flow.png)
...
![总现金为什么不等于可出金现金](assets/withdrawal-availability.png)
...
![券商出金到账后的核对闭环](assets/arrival-reconciliation.png)

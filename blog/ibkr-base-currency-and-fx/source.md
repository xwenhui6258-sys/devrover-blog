...
summary: "把 IBKR 的基础货币、分币种现金、交易货币、外汇货币对、自动换汇和负现金拆开讲清，再完成一次可核对的换汇。"
date: 2026-07-13
updated: 2026-07-14
category: "美股账户"
series: "美股新手基础设施"
...
> 本文为个人经验记录和 IBKR 多币种账户、换汇操作说明，不构成投资、税务或法律建议，也不是外汇交易、跨境汇款或融资建议。自动换汇能力会因开户实体、账户类型、地区、产品和使用平台而不同，费用也会调整。操作前以当前账户预览页、协议和官方费率为准。资料核对日期：2026-07-14。

![基础货币与实际持仓货币的区别](assets/base-vs-holdings.png)
...
![IBKR 换汇与买入外币资产的判断路径](assets/currency-conversion-flow.png)
...
![换汇前后的核对清单](assets/fx-checklist.png)

...
![ETF：从一个代码到一篮子资产](assets/etf-one-code-basket-cover.png)
...
![ETF 的二级市场交易与大额创设/赎回机制](assets/etf-two-layer-trading-structure.png)
...
![买入 ETF 前的五个核对问题](assets/etf-buy-before-checklist.png)

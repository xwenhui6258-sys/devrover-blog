...
summary: "同一个 IBKR App 背后可能是不同法律实体、监管机构和客户保护安排。本文用客户协议、结单、监管登记和安全消息确认自己的账户归属。"
date: 2026-07-15
updated: 2026-07-15
slug: "ibkr-account-entity-and-regulation"
category: "跨境投资"
series: "海外资产入门"
status: "published"
...
![IBKR 品牌、签约实体、清算托管与监管关系](assets/ibkr-account-entity-map.png)
...
![投资者保护的四个判断条件](assets/ibkr-investor-protection-boundaries.png)
...
![确认 IBKR 账户归属的五步证据链](assets/ibkr-entity-verification-checklist.png)

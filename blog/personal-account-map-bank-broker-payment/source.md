...
series: "海外资产入门"
status: "draft"
cover: "assets/personal-account-role-map.png"
tags:
  - 账户管理
  - 入金出金
  - 风险管理
...
> 本文是一般性的账户管理教育内容，不构成银行、支付、开户、投资、税务、法律或跨境资金建议。不同国家和地区、法律实体、账户类型与客户身份适用不同规则。文中的制度边界已于 2026-08-09 按文末官方资料核对；处理自己的账户时，请以签约实体、账户协议和当前官方说明为准。

![银行卡、券商和支付工具的三类任务](assets/personal-account-role-map.png)
...
![个人账户的消费线和投资线](assets/account-money-flow-boundaries.png)
...
![个人账户盘点表的十个字段](assets/personal-account-inventory-checklist.png)
...
2026 年 8 月 9 日复核时，本文重新检查了中国存款保险、美国 FDIC 与 SIPC 的保护对象和限额表达，并保留各制度的地域、机构、产品和法定情形边界。账户 App 中看到的余额或产品名称，不能单独证明它属于某项存款或投资者保护范围。

这张账户地图也不是开户数量建议。它的用途是记录机构实体、资金任务、进出路径、恢复方式和复查日期，帮助读者发现重复账户、单点故障和无法解释的资金路径。
